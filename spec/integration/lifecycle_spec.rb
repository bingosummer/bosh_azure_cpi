...
describe Bosh::AzureCloud::Cloud do
  before(:all) do
    ...
    @storage_access_key   = ENV['BOSH_AZURE_STORAGE_ACCESS_KEY']   || raise("Missing BOSH_AZURE_STORAGE_ACCESS_KEY")
  ...
  let(:instance_type)   { ENV.fetch('BOSH_AZURE_INSTANCE_TYPE', 'Standard_A1') }
  ...
  def vm_lifecycle(stemcell_id, network_spec)
